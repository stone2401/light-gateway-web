...
export async function accountMenu(options?: RequestOptions) {
  return request<API.AccountMenus[]>('/api/v1/account/menus', {
    method: 'GET',
    ...(options || {}),
  });
}
...
export async function accountPermissions(options?: RequestOptions) {
  return request<string[]>('/api/v1/account/permissions', {
    method: 'GET',
    ...(options || {}),
  });
}
...
export async function accountProfile(options?: RequestOptions) {
  return request<API.AccountInfo>('/api/v1/account/profile', {
    method: 'GET',
    ...(options || {}),
  });
}
