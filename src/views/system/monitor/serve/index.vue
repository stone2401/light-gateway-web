  ...
  <div class="sys-server-stat-container">
    ...
    <Card class="stat-card" title="运行环境">
      <Descriptions :column="1" :label-style="{ width: '50%' }">
        ...
        <Descriptions.Item label="GoLang版本">
          <Tag color="processing" size="small">{{ runtime.goVersion }}</Tag>
        </Descriptions.Item>
    ...
    <Card class="stat-card" title="CPU">
      <Descriptions :column="1" :label-style="{ width: '50%' }" :content-style="{ width: '50%' }">
        ...
        <Descriptions.Item label="负载">
          <Progress :percent="cpu.allLoad" :stroke-color="customProgressColor" />
        </Descriptions.Item>
        <Descriptions.Item
          ...
          :label="`核心${index + 1} 负载`"
        >
          <Progress :percent="item.coreLoad" :stroke-color="customProgressColor(item.coreLoad)" />
        </Descriptions.Item>
      </Descriptions>
    </Card>
  </div>
